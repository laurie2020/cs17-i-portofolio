    ...
    <section id="portfolio" class="portfolio section-bg">
        <div class="container">
          ...
          <div class="row portfolio-container" data-aos="fade-up" data-aos-delay="100">
            ...
            <div class="col-lg-4 col-md-6 portfolio-item {{ $portofolio->categorie }}"}>
              <div class="portfolio-wrap">
                <img src={{ asset($portofolio->image) }} class="img-fluid" alt="">
                <div class="portfolio-links">
                  <a href={{ asset($portofolio->image) }} data-gall="portfolioGallery" class="venobox" title="App 1"><i class="bx bx-plus"></i></a>
